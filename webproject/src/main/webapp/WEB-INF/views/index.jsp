            ...
            <div class="container " style="width:100%;overflow:hidden;">
                ...
                <div class="collapse navbar-collapse navbar-responsive-collapse" id="king-horizontal-nav2-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <a href="###" class="avatar">
                            <img src="${sessionScope.STATIC_URL}img/getheadimg.jpg" width="40" alt="Avatar"
                                 class="avatar-img">
    ...
    <div class="king-layout2-main mt15" style="width:960px;">
        <form class="form-horizontal">
            <div class="form-group clearfix ">
                ...
                <div class="col-sm-9">
                    <select name="" id="serviceSelect" class="form-control bk-valign-top">
            ...
            <div class="form-group clearfix ">
                ...
                <div class="col-sm-9">
                    <select name="" id="osSelect" class="form-control bk-valign-top">
                        <option value="选择项1">Linux</option>
                        <option value="选择项1">Windows</option>
                        <option value="选择项1">Aix</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group clearfix ">
                ...
                <div class="col-sm-9">
                    <input class="form-control bk-valign-top" placeholder="ip地址"/>
                </div>
            </div>
            <div class="form-group clearfix ">
                <label class="col-sm-3 control-label bk-lh30 pt0">端口：</label>
                <div class="col-sm-9">
                    <input class="form-control bk-valign-top" placeholder="22"/>
                </div>
            </div>
            <div class="form-group clearfix ">
                <label class="col-sm-3 control-label bk-lh30 pt0">账号：</label>
                <div class="col-sm-9">
                    <input class="form-control bk-valign-top" placeholder="root"/>
                </div>
            </div>
            <div class="form-group clearfix ">
                <label class="col-sm-3 control-label bk-lh30 pt0">密码：</label>
                <div class="col-sm-9">
                    <input class="form-control bk-valign-top" type="password" placeholder="请输入密码"/>
                </div>
            </div>

            <div class="form-group clearfix">
                <div class="col-sm-9 col-sm-offset-3">
                    <button type="button" class="king-btn mr10  king-success">执行安装</button>
                </div>
            </div>
        </form>

        <div class="panel panel-default pannel-overflow panel-tables table7_demo">
            <div class="panel-heading"><i class="fa fa-list-ulx"></i> 已安装agent的主机列表
            </div>
...
<script>
    ...
    $(function () {
        $.ajax({
            method: 'GET',
            url: "${sessionScope.SITE_URL}rest/test/list",
            success: function (result) {
                // console.log(result);
                $('#serviceSelect').empty();
                if (result.result) {
                    var serviceList = result.data.info;
                    // console.log(serviceList);
                    for (var i = 0; i < result.data.count; i++) {
                        // console.log(serviceList[i].bk_biz_id);
                        // console.log(serviceList[i].bk_biz_name);
                        $('#serviceSelect').append('<option value="' + serviceList[i].bk_biz_id + '">' + serviceList[i].bk_biz_name + '</option>');
                    }
                }
            },
            dataType: "json",
        ...
        $.ajax({
            methods:'GET',
            url: '${sessionScope.SITE_URL}rest/test/hostList',
            success: function (result) {
                console.log(result);
